...
public class SimpleFogRenderFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    SimpleFogRenderPass simpleFogRenderPass;

    public override void Create()
    {
        simpleFogRenderPass = new SimpleFogRenderPass(
          "My custom pass",
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        var camDepth = renderer.cameraDepth;
        simpleFogRenderPass.Setup(cameraColor, camDepth);

        // Ask the renderer to add our pass.
        // Could queue up multiple passes and/or pick passes to use
        renderer.EnqueuePass(simpleFogRenderPass);
    }
}